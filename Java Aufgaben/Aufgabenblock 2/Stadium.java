public class Stadium {
    ...
    // Konstruktor
    public Stadium(String name, String adresse, int maxZuschauer, int aktuelleZuschauer) {
        this.name = name;
    ...
    // Setter-Methoden mit Überprüfung
    ...
    public static void main(String[] args) {
        Stadium stadion = new Stadium("Teststadium", "München, Deutschland", 88888, 50000);
        stadion.print();
    }
}
